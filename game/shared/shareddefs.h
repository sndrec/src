...
#else
#define PLAYER_FATAL_FALL_SPEED		1536 // approx 60 feet
#define PLAYER_MAX_SAFE_FALL_SPEED	768 // approx 20 feet
...
#endif
#define DAMAGE_FOR_FALL_SPEED		60.0f / ( PLAYER_FATAL_FALL_SPEED - PLAYER_MAX_SAFE_FALL_SPEED ) // damage per unit per second.
