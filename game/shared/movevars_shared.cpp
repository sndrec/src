...
ConVar	sv_maxvelocity	( "sv_maxvelocity","2000", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any ballistically moving object is allowed to attain per axis." );
